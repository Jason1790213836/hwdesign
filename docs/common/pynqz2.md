...
After you have purchased the board, you can follow this [excellent Youtube video](https://pynq.readthedocs.io/en/v2.3/getting_started/pynq_z2_setup.html) to set up the board.  Some items I noticed:
